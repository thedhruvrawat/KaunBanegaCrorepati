###########################################################################################
ReadMe for assignment submitted by 2019B3PS0537P
Practical section number: P7
Asignment question attempted: 1
###########################################################################################
Team:
1. 2019B3PS0537P	DHRUV RAWAT
2. 2019B2PS0925P	SHUBHAM SHARMA
3. 2019B1PS1039P	VANSH CHHABRA
###########################################################################################
Description of how to run the code and observe the output: 
1. The .zip contains 2019B3PS0537_P7.c which is the only code file. Please ensure that this file and the questions folder are located in same location. Also for better understanding we have also added an infographic (created by us) in the .zip folder and also some screenshots of the program when run by us. 
2. Unzip the folder and navigate to it using the terminal.
3. To run the file, use gcc 2019B3PS0537P_P7.c -o 2019B3PS0537P_P7.exe followed by ./2019B3PS0537P_P7.exe. We couldn't provide the executable file from our end due to security restrictions on Gmail. 
...
1. All the features mentioned in the instructions document have been implemented.
2. The user has to press Enter twice when the user loses/quits/becomes a crorepati. 
############################################################################################
Contributions of the team members:
Dhruv Rawat made the main game, all the lifelines, file-handling and the colors using ANSI escape sequences.
Shubham Sharma made the main user menu, the developers page, and all the congratulations and quit game screens 
Vansh Chhabra made the question value screen, instructions screen and also all the text files and the questions contained within them. He also helped with the file handling part
############################################################################################
